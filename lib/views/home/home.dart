...
import 'package:kyveli/views/filter/searchView.dart';
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () => Navigator.push(
                                context,
                                SlideBottomRoute(
                                    page: SearchView(Provider.of<HomeProvider>(
                                            context,
                                            listen: false)
                                        .verticalView))),
                            child: Center(
                ...
                ContainerResponsive(
                  ...
                  child: Consumer<HomeProvider>(
                    ...
                    return ListView.builder(
                      ...
                      padding: EdgeInsetsResponsive.only(right: 18.0, left: 18),
                      itemBuilder: (context, index) => Padding(
                        padding: EdgeInsetsResponsive.only(right: 9.0, left: 9),
                        child: Column(
                          children: [
                            ClipRRect(
